...
class ExampleApplicationViewController: UIViewController {
    ...
    func createAlert() {
        ...
        let alertViewFrame: CGRect = CGRect.init(x: 0, y: 0, width: alertWidth, height: alertHeight)
        alertView = UIView(frame: alertViewFrame)
        alertView.backgroundColor = UIColor.red
        alertView.alpha = 0.0
        alertView.layer.cornerRadius = 10;
        alertView.layer.shadowColor = UIColor.black.cgColor;
        alertView.layer.shadowOffset = CGSize.init(width: 0, height: 5)
        ...
        button.frame = CGRect.init(x: 0, y: 0, width: alertWidth, height: 40.0)
    ...
    func showAlert() {
        ...
        var snapBehaviour: UISnapBehavior = UISnapBehavior(item: alertView, snapTo: view.center)
    ...
    @objc func dismissAlert() {
        ...
        gravityBehaviour.gravityDirection = CGVector.init(dx: 0.0, dy: 10.0)
...
//                animator.removeAllBehaviors()
//
//                let offset = UIOffset(horizontal: panLocationInAlertView.x - CGRectEdge.midX(alertView.bounds), vertical: panLocationInAlertView.y - CGRectEdge.midY(alertView.bounds));
